# Copyright (c) DabblingBadger LLC.
# Author: Jonathan Badger
# Adapted from the GitHub SAM 3 repository, which was in turn copied and
# lightly adapted from the VE repo, which in turn copied from open_clip and
# OpenAI CLIP.
